package com.miaad.tp_gui_miaad;
    ...
    class Conversation extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                pw.println("Bienvenu, vous etes le client num�ro "+numero);
                System.out.println("Connexion du client num�ro "+numero+", IP = "+ipClient);
                    ...
                    if (correctFormatRequest) {
                        ...
                        if(fin == false) {
                            if(nombre > nombreSecret) {
                                pw.println("Votre nombre est sup�rieur au nombre secret");
                            }else if(nombre < nombreSecret) {
                                pw.println("Votre nombre est inf�rieur au nombre secret");
                            }else {
                            ...
                            pw.println("Jeu termin�, le gagnant est : "+gagnant);
                        }
                    }else {
